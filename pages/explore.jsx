...
useEffect(() => {
  const fetchData = async () => {
    try {
      const response = await fetch(`/api/createroom?adminId=${session?.user?.id}`);
              ...
              <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div className="px-6 py-6 lg:px-8">
                  ...
                  <form className="space-y-6" action="#">
                    ...
                    <select onChange={updateGoal} id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div>
                      ...
                      <div className="flex items-center mb-4">
                          <input defaultChecked id="default-radio-2" type="radio" value="flexible" name="default-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                          onChange={updateAvailibility}
                          // onClick={setAvailability("anytime")}
                          />
                          <label for="default-radio-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">I’m flexible / I’m available all the time</label>
                      </div>
                      <div className="flex items-center mb-4">
                          <input id="default-radio-1" type="radio" value="weekdays" name="default-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                          onChange={updateAvailibility}
                          // onClick={setAvailability("weekdays")}
                          />
                          <label for="default-radio-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Weekdays</label>
                      </div>
                      <div className="flex items-center ">
                          <input id="default-radio-3" type="radio" value="weekends" name="default-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                          onChange={updateAvailibility}
                          // onClick={setAvailability("weekends")}
                          />
                          <label for="default-radio-3" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Weekends</label>
                      </div>
        ...
        <div className="grid grid-rows-2 gap-4">
          <div className="bg-white rounded-lg shadow-xl border border-black p-4 w-full mt-4">
            ...
            <div className="flex justify-between items-start mb-2 bg-gray-50 p-2 rounded-xl hover:bg-gray-100 w-full">
              ...
              <img
                  ...
                  alt=""
                />
                <span className="font-semibold text-gray-800 my-auto">Ezio Dani</span>
              </div>
          ...
          <div className="bg-white  rounded-lg shadow-xl border border-black p-4 w-full">
            ...
            <ul className="space-y-1 text-gray-500 list-inside dark:text-gray-400">
              {
                requestedRooms !== null && requestedRooms.length > 0 ? requestedRooms.map((room) => (
                  <li className="flex items-center bg-gray-50 p-2 rounded-xl hover:bg-gray-100 w-full" key={room?.id}> 
                <svg
                ...
                <span className="font-semibold text-gray-800 flex flex-row my-auto">{room?.goal}</span>
                <div>
                  <button
