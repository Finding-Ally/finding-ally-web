...
export default function FeedBack(){
    ...
    return (
        ...
        <div className="py-8 lg:py-16 md:px-4 px-2 mx-auto max-w-screen-md ">
            <h2 className="text-3xl tracking-tight font-extrabold text-gray-900 dark:text-white">Report User</h2>
            <p className="mb-8 lg:mb-8 text-gray-500 dark:text-gray-400 ">report a user for inappropriate behavior</p>
